-- campus_service database table structure export
-- Exported at: 2026-05-19 18:40:53
-- Source: campus-server/db/init.sql
...
VALUES
  ('upload_max_size_mb', '5', '鍗曞紶鍥剧墖鏈€澶т笂浼犲ぇ灏忥紝鍗曚綅 MB锛? 琛ㄧず涓嶉檺鍒?),
  ('idle_max_images', '20', '闂茬疆鐗╁搧鏈€澶氫笂浼犲浘鐗囨暟閲?),
  ('errand_max_images', '20', '浠ｆ嬁璁㈠崟鏈€澶氫笂浼犲浘鐗囨暟閲?)
